...
<p class="hero-status">
Currently seeking longer-term postdoctoral and industry roles at the intersection
of applied ML, wearables, and human physiology.
<a href="Bowie_CV.pdf">CV (PDF)</a> &middot;
...
<div class="project project-thumb-image">
<div class="project-thumb"><img src="img/bowie-2026-heat-tolerance.png" alt="Graphical abstract: methods, outcomes, and population-specific threshold criteria for heat tolerance classification" /></div>
...
<div class="project project-thumb-image">
<div class="project-thumb"><img src="img/emg-model-effects.png" alt="Mixed-model marginal effects: predicted EMG features (RMS, MDF, MNF, sample entropy) as a function of bout completion at 40% versus 70% one-rep-max load" /></div>
<div class="project-body">
...
<div class="project-links">
<span class="project-note">Repository will be released alongside the manuscript.</span>
</div>
</div>
</div>
...
<div class="project project-thumb-image">
<div class="project-thumb"><img src="img/rtsd-rm1-dose-response.png" alt="Reference-mode test RM1: doubled training dose produces roughly twice the rate of fitness gain over 52 weeks, the dose-response gate the simulator must satisfy" /></div>
<div class="project-body">
  <h3>rtSD Explorer: an interactive fitness-fatigue model explorer</h3>
  <div class="project-meta">Public release &middot; browser-side marimo + R Shiny + Docker</div>
  <p>
...
<!-- Project 4: citation-network visualization. The literature-graph companion
     to rtSD above. Hero PNG is shipped with the site; interactive viewer
     and source repo are planned but deferred until the v0.1.0 release lands. -->

<div class="project project-thumb-dark">
<div class="project-thumb"><img src="img/banister-constellation-hero.png" alt="Citation network of 175 papers across 50 years of fitness-fatigue model research, with the founding Banister 1975 paper at the top and four downstream branches (classical, variable-dose, statistical critique, and Bayesian hierarchical)" /></div>
<div class="project-body">
  <h3>The Banister Constellation: a citation graph of the fitness-fatigue model lineage</h3>
  <div class="project-meta">Research tooling &middot; Python + DuckDB + vis-network</div>
  <p>
  ...
  on a private DuckDB literature index; interactive viewer and source release planned.
  </p>
</div>
</div>
...
<div class="project project-thumb-image">
<div class="project-thumb"><img src="img/unlearning-hero.png" alt="Force-directed knowledge graph with 'Harry' at the center surrounded by Harry-Potter-specific words in red with fading red edges, and new green edges growing toward generic words like 'British' and 'actor'" /></div>
<div class="project-body">
  <h3>Who's Harry Potter? An interactive walk through approximate unlearning in LLMs</h3>
  <div class="project-meta">Portfolio piece &middot; browser-side marimo + Pyodide</div>
  <p>
...
<div class="project project-thumb-teal">
<div class="project-thumb"><span>Literature &middot; citation graph</span></div>
<div class="project-body">
  <h3>Literature acquisition and citation-graph toolkit</h3>
  <div class="project-meta">Open-source &middot; Python + DuckDB</div>
  <p>
  ...
  <p><a href="https://github.com/JacobBowie/literature-pipeline">Repository</a></p>
</div>
</div>
...
<footer class="site-footer">
  ...
  <a href="https://www.linkedin.com/in/jacobbowie/">LinkedIn</a> &middot;
