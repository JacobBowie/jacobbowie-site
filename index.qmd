...
<!-- Project 3: citation-network visualization. Public-safe framing: the
     codename for the parent project is intentionally not referenced. The
     hero PNG is shipped with the site; interactive viewer + source repo
     are planned but deferred until the v0.1.0 release lands. -->
...
<!-- Project 4: literature pipeline tool. -->
