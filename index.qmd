...
<!-- Project 3: synthesim. Public v0.1.0 with live Shiny demo + marimo WASM. -->

<div class="project project-thumb-image">
<div class="project-thumb"><img src="img/synthesim-rm1-dose-response.png" alt="Reference-mode test RM1: doubled training dose produces roughly twice the rate of fitness gain over 52 weeks, the dose-response gate the simulator must satisfy" /></div>
<div class="project-body">
  <h3>synthesim: an interactive fitness-fatigue model explorer</h3>
  <div class="project-meta">Public release v0.1.0 &middot; R Shiny + marimo WASM + Docker</div>
  <p>
  ...
  validator anchored to canonical RT literature. Live Shiny demo, browser-side
  marimo notebook, and reproducible Docker image all in one repo.
  </p>
<div class="project-links">
<a href="https://get-paid.shinyapps.io/synthesim/">Live demo</a>
<a href="https://github.com/JacobBowie/synthesim">Repository</a>
</div>
</div>
</div>

<!-- Project 4: citation-network visualization. The literature-graph companion
     to synthesim above. Hero PNG is shipped with the site; interactive viewer
